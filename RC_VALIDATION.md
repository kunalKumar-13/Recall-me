...
|--------------------------------|---------------------------------------------------------------------------------------------------|---------|
| **Install works**              | [INSTALL_VERIFIED.md](INSTALL_VERIFIED.md) §1-2 — doctor 5 GREEN / 0 RED on the dev box           | ✅ verified (dev) · ⚠️ clean-VM walk = [BUG-002](BUGS_OPEN.md) |
| **Capture works**              | [STABILITY/CAPTURE.md](STABILITY/CAPTURE.md) + [INSTALL_VERIFIED.md](INSTALL_VERIFIED.md) §3 — 36 events today, 166 over 30 d, 3 of 5 named sites confirmed | ✅ verified · ⚠️ SO + Stitch open as [BUG-003](BUGS_OPEN.md) |
| **Resume works**               | [STABILITY/RESUME.md](STABILITY/RESUME.md) + [INSTALL_VERIFIED.md](INSTALL_VERIFIED.md) §4 — pipeline alive, `/v1/recovery/recent` 200 in 122 ms; `ResumePreview` constructs in 3.1 ms | ✅ engine verified · ⚠️ click → tabs-open end-to-end = [BUG-002](BUGS_OPEN.md) |
| **Launcher understandable**    | [STABILITY/LAUNCHER.md](STABILITY/LAUNCHER.md) + [SCREEN_INDEX.md](SCREEN_INDEX.md) — frozen 7E.1 widget tree, 5 captures (home / high / med / low / no_hero) | ✅ frozen + captured |
| **Extension understandable**   | [STABILITY/EXTENSION.md](STABILITY/EXTENSION.md) + [SCREEN_INDEX.md](SCREEN_INDEX.md) — 9-state machine, 7 captures, bundle 296 KB byte-identical across 8B | ✅ frozen + captured |
| **Control room usable**        | [STABILITY/CONTROL.md](STABILITY/CONTROL.md) — 13 routes, 10 loaders, `tsc --noEmit` exit 0      | ✅ build clean · ⚠️ per-route empty-state copy = [CTRL-001](BUGS_OPEN.md) |
...
>     [BUGS_OPEN.md](BUGS_OPEN.md) with a
...
- **Gap:** clean Windows VM walk
  ([BUG-002](BUGS_OPEN.md)). Will be the first
...
- **Gap:** StackOverflow + Stitch report 0
  events ([BUG-003](BUGS_OPEN.md)). Matcher
  audit pending.
...
- **Gap:** end-to-end click → tabs-open
  re-walk pending ([BUG-002](BUGS_OPEN.md)). Was
...
- **Public contract:** `from app.ui.launcher
  ...
  [AUDIT/LAUNCHER_FREEZE.md](AUDIT/LAUNCHER_FREEZE.md).
...
- **Gap:** `loading` + `reconnecting` transient
  captures missing ([EXT-001](BUGS_OPEN.md)) —
...
- **Mechanism:** Next.js App Router under
  ...
  paths module ([STABILITY/CONTROL.md](STABILITY/CONTROL.md)).
...
- **Gap:** per-route empty-state copy not
  audited ([CTRL-001](BUGS_OPEN.md)). Cosmetic;
  doesn't block usage.
...
| [STABILITY/PERF.md](STABILITY/PERF.md) | latency budgets met                    |
| [STABILITY/CAPTURE.md](STABILITY/CAPTURE.md) | event log is real, not fixture       |
| [STABILITY/LAUNCHER.md](STABILITY/LAUNCHER.md) | widget tree is frozen + correct      |
| [STABILITY/RESUME.md](STABILITY/RESUME.md) | composition layers compose            |
| [STABILITY/EXTENSION.md](STABILITY/EXTENSION.md) | state machine + bundle health       |
| [STABILITY/CONTROL.md](STABILITY/CONTROL.md) | admin web routes + loaders           |
| [SCREEN_INDEX.md](SCREEN_INDEX.md)    | visual surface is captured             |
| [VERSION.md](VERSION.md)              | what's frozen, what's blocked          |
| [BUGS_OPEN.md](BUGS_OPEN.md)          | every gap is named with severity       |
