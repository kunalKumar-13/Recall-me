...
| 10.3 — Capture five real launcher screenshots | **Deferred** with named gate ([`PHASE_4A_STATUS.md`](PHASE_4A_STATUS.md), [`assets/screenshots/README.md`](assets/screenshots/README.md)). Replaced placeholder captions in
