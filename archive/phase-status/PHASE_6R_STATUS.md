...
[`docs/product/LAUNCHER_FINAL_AUDIT.md`](../../docs/product/LAUNCHER_FINAL_AUDIT.md)
...
[`archive/launcher-debt/`](../launcher-debt) carries
...
- [`archive/launcher-debt/README.md`](../launcher-debt/README.md)
- 4 captures under
...
- `app/ui/launcher_v3/why_sheet.py` (snapshot in
  [`archive/launcher-debt/why_sheet_6q.py`](../launcher-debt/why_sheet_6q.py))
