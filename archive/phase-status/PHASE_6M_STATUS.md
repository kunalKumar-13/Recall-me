...
Cross-references:
[`DESKTOP_LAYER.md`](../../docs/product/DESKTOP_LAYER.md) (the
product-side story — what the layer is, what it isn't, how it
joins the engine),
[`TRUST.md`](../../docs/product/TRUST.md) (the five-rule public
contract this layer respects),
[`TRUST_LEDGER.md`](../../docs/engineering/TRUST_LEDGER.md) (the on-disk boundary
spec).
...
- [`DESKTOP_LAYER.md`](../../docs/product/DESKTOP_LAYER.md)'s "What the
