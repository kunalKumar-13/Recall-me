...
| **RC1 claims with evidence index**        | 6 implicit | **6 explicit** | new doc ([RC_VALIDATION.md](../../docs/release/RC_VALIDATION.md)) |
...
- One real incident filed during 8E:
  ...
  ([BUG-001](../../docs/engineering/BUGS_OPEN.md)). Self-reported
  by the founder.
...
### 6. RC validation — covered by [`RC_VALIDATION.md`](../../docs/release/RC_VALIDATION.md)
...
### 7. Release-readiness — covered by [`RELEASE_READINESS.md`](../../docs/release/RELEASE_READINESS.md)
...
[8C STABILITY/ set](../../docs/engineering/stability) →
...
- [`RC_VALIDATION.md`](../../docs/release/RC_VALIDATION.md) —
...
- Each of the 6 RC1 claims is backed by an
  artifact ([`RC_VALIDATION.md`](../../docs/release/RC_VALIDATION.md)).
