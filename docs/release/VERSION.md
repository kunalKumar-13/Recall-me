...
|---------------|-----------------------------------|--------------------------------------------------|
| Launcher      | Phase 7E.1 + 8B collapse          | [`AUDIT/LAUNCHER_FREEZE.md`](../../archive/AUDIT/LAUNCHER_FREEZE.md), [`STABILITY/LAUNCHER.md`](../engineering/stability/LAUNCHER.md) |
| Extension     | Phase 7A (6 fixed regions)        | [`STABILITY/EXTENSION.md`](../engineering/stability/EXTENSION.md) |
| Capture       | Phase 7D pipeline (7 hops)        | [`AUDIT/CAPTURE_MAP.md`](../../archive/AUDIT/CAPTURE_MAP.md), [`STABILITY/CAPTURE.md`](../engineering/stability/CAPTURE.md) |
| Resume        | Phase 4E (≥0.55 trust gate)       | [`STABILITY/RESUME.md`](../engineering/stability/RESUME.md) |
| Control room  | Phase 6J (13 routes, 10 loaders)  | [`STABILITY/CONTROL.md`](../engineering/stability/CONTROL.md) |
| Doctor        | Phase 5C                          | `recall doctor` |
| Demo          | Phase 8D (new: `recall demo run`) | [`DEMO_MODE.md`](../product/DEMO_MODE.md) |
...
## Known bugs (RC1 ships with these — see [BUGS_OPEN.md](../engineering/BUGS_OPEN.md))
...
(BUG-004, EXT-002, CTRL-002, BUG-008 are not regressions — they are scope re-classifications. See section 7 of [`PHASE_8D_STATUS.md`](../../archive/phase-status/PHASE_8D_STATUS.md).)
...
Recall follows [SemVer](VERSIONING.md).
...
print(Launcher(None).__class__.__name__, Launcher(None).size())
"
