...
|-----------------------------|---------------------------------------------------|
| local-first                 | [`CLAUDE.md` rule 2](../../../CLAUDE.md), [`STABILITY/CAPTURE.md`](../../engineering/stability/CAPTURE.md) |
| no cloud                    | Same                                              |
| no telemetry                | Same; no analytics SDKs in any `package.json`     |
| counts only                 | [`TRUST_LEDGER.md`](../../engineering/TRUST_LEDGER.md) |
| export only                 | [`TRUST_LEDGER.md`](../../engineering/TRUST_LEDGER.md) |
...
served by the new
[`recall demo run`](../../product/DEMO_MODE.md) CLI than
...
([`SCREEN_INDEX.md`](../../product/SCREEN_INDEX.md)). A
