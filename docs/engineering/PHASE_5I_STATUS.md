...
that target are mapped in [`INSTALL_SIZE_AUDIT_V2.md`](INSTALL_SIZE_AUDIT_V2.md)
and [`MODEL_STRATEGY.md`](MODEL_STRATEGY.md). This phase did the
...
Cross-references: [`FRICTION_FIXED.md`](FRICTION_FIXED.md) (cumulative
ledger), [`OPEN_PROBLEMS.md`](OPEN_PROBLEMS.md) (still-named
work), [`SPLIT_DISTRIBUTION.md`](SPLIT_DISTRIBUTION.md) (the
...
that [`INSTALL_SIZE_AUDIT_V2.md`](INSTALL_SIZE_AUDIT_V2.md) is
written against. Runs in <2 seconds, stdlib only.

**[`docs/engineering/INSTALL_SIZE_AUDIT_V2.md`](INSTALL_SIZE_AUDIT_V2.md)** —
...
**[`docs/engineering/MODEL_STRATEGY.md`](MODEL_STRATEGY.md)** —
...
**[`docs/engineering/SPLIT_DISTRIBUTION.md`](SPLIT_DISTRIBUTION.md)** —
...
|---|---|---|
| Actually rebuild the installer with Tier A excludes | open | the rebuild is 24 minutes on this machine + needs a smoke pass; tracked as the first item in [`OPEN_PROBLEMS.md`](OPEN_PROBLEMS.md) § *Performance* now that the savings math is concrete |
...
[`OPEN_PROBLEMS.md`](OPEN_PROBLEMS.md) row 8 today.
