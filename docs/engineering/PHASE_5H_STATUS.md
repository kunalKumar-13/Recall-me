...
[`PHASE_TRACKER.md`](../founder/PHASE_TRACKER.md) tracks the two
...
Cross-references: [`FRICTION_FIXED.md`](FRICTION_FIXED.md) (the
historical ledger), [`FRICTION_FIXES.md`](FRICTION_FIXES.md) (the
older detailed per-issue receipts), and
[`OPEN_PROBLEMS.md`](OPEN_PROBLEMS.md) (the still-open list).
...
[`FRICTION_FIXED.md`](FRICTION_FIXED.md) with the phase it landed
in. Anything genuinely open goes in
[`OPEN_PROBLEMS.md`](OPEN_PROBLEMS.md) with a one-line scope note.
