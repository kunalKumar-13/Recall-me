...
Cross-references:
[`DAILY_LOOP.md`](../product/DAILY_LOOP.md) (product story —
what the layer means),
[`RETURN_BEHAVIOR.md`](../product/RETURN_BEHAVIOR.md) (return
semantics in detail),
[`MOMENTS.md`](../alpha/MOMENTS.md) (the seven first-time
...
in [`DAILY_LOOP.md`](../product/DAILY_LOOP.md) and pinned in the
...
- [`docs/product/DAILY_LOOP.md`](../product/DAILY_LOOP.md) — the
