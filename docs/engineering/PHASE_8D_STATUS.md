...
### 1. Version lock — covered by [`VERSION.md`](../../VERSION.md)

- v0.1.0-rc1 tagged in [`VERSION.md`](../../VERSION.md).
...
### 2. Release kit — covered by [`release/`](../../release/)

Seven new docs land under `release/`:

| Doc                                              | Purpose |
|--------------------------------------------------|---------|
| [`release/README.md`](../../release/README.md)   | single front door |
| [`release/CHANGELOG_RC1.md`](../../release/CHANGELOG_RC1.md) | release notes (what's in / what changed) |
| [`release/INSTALL.md`](../../release/INSTALL.md) | Windows + macOS + from-source paths |
| [`release/QUICKSTART.md`](../../release/QUICKSTART.md) | 5-minute install → resume walkthrough |
| [`release/DEMO_FLOW.md`](../../release/DEMO_FLOW.md) | 3-minute screen-share demo script |
| [`release/KNOWN_ISSUES.md`](../../release/KNOWN_ISSUES.md) | user-facing bug summary |
| [`release/LANDING_CHECK.md`](../../release/LANDING_CHECK.md) | marketing-site link audit |

Quickstart's 5-step loop matches the directive
verbatim: **install → open extension → browse →
leave → resume**.

### 3. Screen freeze — covered by [`SCREEN_INDEX.md`](../../SCREEN_INDEX.md)
...
### 4. Demo package — covered by [`DEMO_MODE.md`](../../DEMO_MODE.md)
...
### 5. Install test — covered by [`INSTALL_VERIFIED.md`](../../INSTALL_VERIFIED.md)
...
### 6. Landing check — covered by [`release/LANDING_CHECK.md`](../../release/LANDING_CHECK.md)
...
### 7. RC bug pass — covered by [`BUGS_OPEN.md`](../../BUGS_OPEN.md)
...
### 8. Release score — covered by [`RELEASE_READINESS.md`](../../RELEASE_READINESS.md)
...
+ the [`STABILITY/`](../../STABILITY/) set (8C).
...
- [`VERSION.md`](../../VERSION.md) — v0.1.0-rc1 spec
- [`SCREEN_INDEX.md`](../../SCREEN_INDEX.md) — frozen capture surface
- [`DEMO_MODE.md`](../../DEMO_MODE.md) — demo CLI reference
- [`INSTALL_VERIFIED.md`](../../INSTALL_VERIFIED.md) — install walk
...
1. **Version locked.** v0.1.0-rc1 in
   [`VERSION.md`](../../VERSION.md). 8 surfaces
   frozen.
2. **Release kit shipped.** 7 docs in
   [`release/`](../../release/) covering install
...
- Public-alpha rollout per
  [`docs/founder/PUBLIC_ALPHA.md`](../founder/PUBLIC_ALPHA.md)
