const HEALTH = "http://127.0.0.1:4545/v1/health";
...
// Health check the local daemon. Phase 2A serves health from
// `/v1/health` (and keeps `/health` working for older popups).
(async () => {
  try {
