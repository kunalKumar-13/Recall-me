  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(181, 168, 255, 0.45) 0%, rgba(125, 216, 232, 0.18) 35%, transparent 70%)",
        }}
      />
      {/* Mid ring — slightly tighter halo */}
      <div
        className="absolute inset-6 rounded-full"
        style={{
          background:
            "radial-gradient(circle, rgba(181, 168, 255, 0.55) 0%, transparent 65%)",
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 35% 30%, rgba(232, 226, 251, 0.95) 0%, rgba(169, 156, 247, 0.95) 35%, rgba(125, 95, 200, 1) 75%)",
          boxShadow:
            "0 0 40px 4px rgba(169, 156, 247, 0.55), inset 0 -8px 14px rgba(80, 60, 150, 0.5)",
        }}
      />
      {/* Inner highlight pip */}
      <div
      ...
      />
      {/* Slow rotating glint — pure transform, GPU-only */}
      <motion.div
        className="absolute inset-12 rounded-full pointer-events-none gpu"
        style={{
          background:
            "conic-gradient(from 0deg, transparent 0deg, rgba(255,255,255,0.18) 60deg, transparent 120deg, transparent 360deg)",
          mixBlendMode: "screen",
        }}
        animate={{ rotate: 360 }}
...
export function MemoryVisualization() {
  return (
    <section
      ...
      "
    >
      {/* Soft cinematic top + side glow */}
      <div
        aria-hidden
        className="absolute inset-x-0 top-0 h-[55%] pointer-events-none"
        style={{
          background:
            "radial-gradient(ellipse 60% 75% at 50% 0%, rgba(181, 168, 255, 0.16), transparent 70%)",
        }}
      />
      <div
        aria-hidden
        className="absolute inset-y-0 -right-32 w-[40%] pointer-events-none"
        style={{
          background:
            "radial-gradient(ellipse 60% 50% at 100% 50%, rgba(125, 216, 232, 0.08), transparent 70%)",
        }}
      />
      ...
      <div className="relative max-w-5xl mx-auto">
        ...
        <div className="text-center mb-14 md:mb-16">
          ...
          <motion.h2
            ...
            className="font-editorial mt-3 text-[30px] md:text-[44px] font-medium tracking-editorial leading-[1.06] text-white"
          >
