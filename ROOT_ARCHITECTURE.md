...
|---|---|---|
| `/v1/*` HTTP API | Launcher ↔ extension (extension → API); future plugins | Versioned; semver-protected per [`VERSIONING.md`](VERSIONING.md) |
...
|---|---|---|
| `apps/desktop` | A signed tag on `main` (`vMAJOR.MINOR.PATCH`) | Release engineer, via the checklist in [`RELEASE.md`](RELEASE.md) |
