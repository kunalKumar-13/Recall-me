...
chat-platform sessions, and POSTs them to `127.0.0.1:49827`.
...
1. Make sure the Recall desktop app is running. Confirm in Settings →
   Browser Memory that the listener is "Listening on 127.0.0.1:49827".
...
- The extension's `host_permissions` is exactly one URL —
  `http://127.0.0.1:49827/*`. Chrome will refuse any other network
